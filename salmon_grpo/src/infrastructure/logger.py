...
from src.infrastructure.dist_utils import is_dist_avail_and_initialized, is_main_process
            ...
            if i % print_freq == 0 or i == len(iterable) - 1:
                if is_main_process():
                    if logger is not None:
                        ...
                        for name, meter in self.meters.items():
                            logger.add_scalar("{}".format(name), meter.global_avg, global_step=start_step+i)
